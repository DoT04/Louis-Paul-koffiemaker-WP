...
class AWB_Settings {
    ...
    public function print_settings_page() {
        ...
        wp_enqueue_style( 'nk-awb-settings', nk_awb()->plugin_url . 'assets/admin/settings/style.min.css', '', '1.6.6' );
        wp_enqueue_script( 'nk-awb-settings', nk_awb()->plugin_url . 'assets/admin/settings/script.min.js', array( 'jquery' ), '1.6.6', true );
    }
}
new AWB_Settings();
